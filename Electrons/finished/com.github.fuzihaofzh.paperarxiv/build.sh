...
export PACKAGE="com.github.fuzihaofzh.paperarxiv"
export NAME="PaperArxiv"
export VERSION="0.1.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/fuzihaofzh/PaperArxiv/releases/download/v0.1.2/paperarxiv_0.1.2_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Another paper management tool"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/fuzihaofzh/PaperArxiv"
export AUTHOR="fuzihaofzh"

function build() {
    pushd $SRC_DIR/*
    cp -r usr/lib/paperarxiv* ${APP_DIR}/files/
