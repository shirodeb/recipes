...
export PACKAGE="com.github.smartholdemdapps.heads-tails"
export NAME="heads-tails"
export VERSION="1.0.14"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/SmartHoldemDAPPs/heads-tails"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="SmartHoldem Heads or Tails Blockchain Multiplayer Game"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/SmartHoldemDAPPs/heads-tails"
export AUTHOR="SmartHoldemDAPPs"
