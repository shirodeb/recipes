...
export PACKAGE="com.github.antonreshetov.image-optimizer"
export NAME="Image Optimizer"
export VERSION="1.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/antonreshetov/image-optimizer"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A free and open source tool for optimizing images and vector graphics."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/antonreshetov/image-optimizer"
