...
export PACKAGE="com.github.manusa.electronim"
export NAME="ElectronIM"
export VERSION="0.0.97"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/manusa/electronim/releases/download/v0.0.97/electronim-linux-x64.tar.gz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Electron based multi IM (Instant Messaging) client"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/manusa/electronim"
export AUTHOR="manusa"
