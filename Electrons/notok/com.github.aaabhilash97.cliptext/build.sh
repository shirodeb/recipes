...
export PACKAGE="com.github.aaabhilash97.cliptext"
export NAME="cliptext"
export VERSION="2.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/aaabhilash97/cliptext"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Clipboard manager for macOS. Built with Electron.js"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/aaabhilash97/cliptext"
export AUTHOR="aaabhilash97"
