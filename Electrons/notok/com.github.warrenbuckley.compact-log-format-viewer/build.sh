...
export PACKAGE="com.github.warrenbuckley.compact-log-format-viewer"
export NAME="Compact Log Viewer"
export VERSION="1.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/warrenbuckley/Compact-Log-Format-Viewer/releases/download/v1.4.0/Compact-Log-Viewer-1.4.0.appx"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A cross platform tool to read & query JSON aka CLEF log files created by Serilog"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/warrenbuckley/Compact-Log-Format-Viewer"
export AUTHOR="warrenbuckley"
