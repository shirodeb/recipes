...
export PACKAGE="com.github.eugeny.tabby"
export NAME="Tabby Terminal"
export VERSION="1.0.201"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Eugeny/tabby/releases/download/v1.0.201/tabby-1.0.201-linux-x64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A terminal for a more modern age"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Eugeny/tabby"
export AUTHOR="Eugeny"
