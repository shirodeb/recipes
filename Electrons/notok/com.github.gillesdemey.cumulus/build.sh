...
export PACKAGE="com.github.gillesdemey.cumulus"
export NAME="Cumulus"
export VERSION="0.10.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/gillesdemey/Cumulus"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="☁️  A SoundCloud player that lives in your menubar."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/gillesdemey/Cumulus"
export AUTHOR="gillesdemey"
