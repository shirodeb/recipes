...
export PACKAGE="com.github.deskfiler.deskfiler"
export NAME="Deskfiler"
export VERSION="1.2.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/deskfiler/deskfiler/releases/download/v1.2.3/Deskfiler-1.2.3.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A safe and easy environment to publish Javascript Desktop Apps: everday helpers and tools!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/deskfiler/deskfiler"
export AUTHOR="deskfiler"
