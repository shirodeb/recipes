...
export PACKAGE="com.github.jcv8000.codex"
export NAME="Codex"
export VERSION="2.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jcv8000/Codex/releases/download/v$VERSION/Codex-$VERSION.tar.xz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A free note-taking software for programmers and Computer Science students"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jcv8000/Codex"
export AUTHOR="jcv8000"
