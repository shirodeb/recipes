...
export PACKAGE="com.github.monsterkodi.kalk"
export NAME="kalk"
export VERSION="0.16.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/monsterkodi/kalk"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="kalkulator"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/monsterkodi/kalk"
