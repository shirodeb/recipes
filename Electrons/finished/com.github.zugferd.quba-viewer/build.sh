...
export PACKAGE="com.github.zugferd.quba-viewer"
export NAME="Quba E-Invoice Viewer"
export VERSION="1.3.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ZUGFeRD/quba-viewer/releases/download/v1.3.0/Quba-1.3.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Quba is a viewer for electronic invoices"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/ZUGFeRD/quba-viewer"
export AUTHOR="ZUGFeRD"
