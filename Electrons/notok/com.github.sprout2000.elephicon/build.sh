...
export PACKAGE="com.github.sprout2000.elephicon"
export NAME="Elephicon"
export VERSION="2.7.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/sprout2000/elephicon/releases/download/v2.7.5/Elephicon-2.7.5-win32-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A GUI wrapper for png2icons."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/sprout2000/elephicon"
