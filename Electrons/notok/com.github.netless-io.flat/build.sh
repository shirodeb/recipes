...
export PACKAGE="com.github.netless-io.flat"
export NAME="Agora Flat"
export VERSION="2.3.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/netless-io/flat"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Project flat is the Web, Windows and macOS client of Agora Flat open source classroom."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/netless-io/flat"
export AUTHOR="netless-io"
