...
export PACKAGE="com.github.mrdavidrios.remindr-releases"
export NAME="Remindr"
export VERSION="2.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/MrDavidRios/remindr_releases/releases/download/v2.0.2/Remindr-2.0.2.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop app to help you keep track of what you need to get done."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/MrDavidRios/remindr_releases"
export AUTHOR="MrDavidRios"
