...
export PACKAGE="com.github.awehook.blink-mind-desktop"
export NAME="Blink Mind Desktop"
export VERSION="0.1.7"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/awehook/blink-mind-desktop"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=" Cross-platform full-featured mind mapping and outline app based on electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/awehook/blink-mind-desktop"
export AUTHOR="awehook"
