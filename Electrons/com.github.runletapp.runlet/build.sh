...
export PACKAGE="com.github.runletapp.runlet"
export NAME="Runlet"
export VERSION="1.0.8"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/runletapp/runlet/releases/download/1.0.8/runlet_1.0.8_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":cloud: A cloud-based job manager that integrates your devices"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/runletapp/runlet"
export AUTHOR="runletapp"
