...
export PACKAGE="com.github.moh3n9595.neu-calculator"
export NAME="NeuCalculator"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/moh3n9595/neu-calculator"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Calculate with neumorphism UI and enjoy!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/moh3n9595/neu-calculator"
export AUTHOR="moh3n9595"
