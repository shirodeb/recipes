...
export PACKAGE="com.github.hr.crypter"
export NAME="Crypter"
export VERSION="4.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/HR/Crypter/releases/download/v4.0.0/Crypter-4.0.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🔓✨🔒 An innovative, convenient and secure encryption app"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/HR/Crypter"
export AUTHOR="HR"
