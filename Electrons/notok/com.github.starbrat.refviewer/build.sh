...
export PACKAGE="com.github.starbrat.refviewer"
export NAME="RefViewer"
export VERSION="4.2.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/limbank/refviewer/releases/download/v4.2.5/refviewer.4.2.5.unpacked.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="RefViewer is an image viewer designed to aid artists and developers alike in their creative process."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/starbrat/refviewer"
export AUTHOR="starbrat"
