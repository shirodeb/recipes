...
export PACKAGE="com.github.alibaba.lightproxy"
export NAME="LightProxy"
export VERSION="1.1.41"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/alibaba/lightproxy"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="💎 Cross platform Web debugging proxy"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/alibaba/lightproxy"
export AUTHOR="alibaba"
