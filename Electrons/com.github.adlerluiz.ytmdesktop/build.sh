...
export PACKAGE="com.github.adlerluiz.ytmdesktop"
export NAME="YTMDesktop App"
export VERSION="1.13.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ytmdesktop/ytmdesktop/releases/download/v1.13.0/YouTube-Music-Desktop-App-1.13.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A Desktop App for YouTube Music"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/adlerluiz/ytmdesktop"
export AUTHOR="adlerluiz"
