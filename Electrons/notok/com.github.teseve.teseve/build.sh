...
export PACKAGE="com.github.teseve.teseve"
export NAME="Tèsèvè"
export VERSION="0.5.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/teseve/teseve/releases/download/0.5.3/Teseve-0.5.3-win32-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A simple static webserver, in an app."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/teseve/teseve"
export AUTHOR="teseve"
