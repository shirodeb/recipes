...
export PACKAGE="com.github.jasperapp.jasper"
export NAME="Jasper"
export VERSION="1.1.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jasperapp/jasper/releases/download/v1.1.2/jasper_v1.1.2_linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Jasper - A flexible and powerful issue reader for GitHub"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jasperapp/jasper"
export AUTHOR="jasperapp"
