...
export PACKAGE="com.github.web-pal.dbglass"
export NAME="DBGlass"
export VERSION="0.1.0-beta.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/web-pal/DBGlass/releases/download/v0.1.0-beta.6/linux-x64.tar.gz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="PostgreSQL client built with Electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/web-pal/DBGlass"
export AUTHOR="web-pal"
