...
export PACKAGE="com.github.levminer.authme"
export NAME="Authme"
export VERSION="4.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="authme-4.2.0-linux-x64.AppImage::https://github.com/Levminer/authme/releases/download/4.2.0/authme-4.2.0-linux-x64.appimage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simple cross-platform two-factor (2FA) authenticator app for desktop."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Levminer/authme"
export AUTHOR="Levminer"

function build() {
    pushd $SRC_DIR/${SRC_NAMES[0]}
    cp -r * ${APP_DIR}/files/
    local EXEC_PATH="/opt/apps/$PACKAGE/files/AppRun"
