...
export PACKAGE="com.github.qmui.qmui_web_desktop"
export NAME="QMUI Web"
export VERSION="2.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Tencent/QMUI_Web_Desktop/releases/download/2.0.0/QMUI-2.0.0-win32-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The desktop app that streamlines projects based on QMUI Web."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/QMUI/qmui_web_desktop"
export AUTHOR="QMUI"
