...
export PACKAGE="com.github.autonomoussoftware.metronome-wallet-desktop"
export NAME="Metronome Wallet"
export VERSION="1.4.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/autonomoussoftware/metronome-wallet-desktop/releases/download/v1.4.3/metronome-desktop-wallet_v1.4.3.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="💻💰 Metronome wallet for desktop devices"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/autonomoussoftware/metronome-wallet-desktop"
export AUTHOR="autonomoussoftware"

function build() {
    pushd $SRC_DIR/*
    cp -r "opt/Metronome Wallet"/* ${APP_DIR}/files/
