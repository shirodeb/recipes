...
export BUILD_DEPENDS="libminizip-dev, libpcap-dev, qtmultimedia5-dev, libmaxminddb-dev, libsmi2-dev, libbrotli-dev, liblz4-dev, libsnappy-dev, libnghttp2-dev, liblua5.1-0-dev, libnl-3-dev, libsbc-dev, libspandsp-dev, libopus-dev, libspeexdsp-dev, asciidoctor, libc-ares-dev, libpcre2-dev, qttools5-dev, flex"
