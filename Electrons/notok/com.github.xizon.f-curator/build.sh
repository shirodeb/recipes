...
export PACKAGE="com.github.xizon.f-curator"
export NAME="F-Curator"
export VERSION="1.3.7"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/xizon/F-Curator/releases/download/v1.3.7/F-Curator.win.1.3.7.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="F-Curator is an offline application that comes at you all day long and curates your own web favorites. via https://www.electronjs.org/apps"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/xizon/F-Curator"
export AUTHOR="xizon"
