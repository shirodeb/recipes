...
export PACKAGE="com.github.tariibaba.beveldm"
export NAME="Bevel Download Manager"
export VERSION="0.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/tariibaba/beveldm/releases/download/v0.4.0/BevelDM-Installer-0.4.0-linux-x64.tar.gz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Cross-platform download manager"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/tariibaba/beveldm"
export AUTHOR="tariibaba"
