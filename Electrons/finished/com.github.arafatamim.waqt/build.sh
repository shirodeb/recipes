...
export PACKAGE="com.github.arafatamim.waqt"
export NAME="Waqt"
export VERSION="1.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/arafatamim/waqt"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Electron-based app to display today's Islamic prayer times."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/arafatamim/waqt"
export AUTHOR="arafatamim"
