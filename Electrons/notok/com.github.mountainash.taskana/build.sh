...
export PACKAGE="com.github.mountainash.taskana"
export NAME="Taskana"
export VERSION="1.17.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/mountainash/taskana"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Download the latest version at:"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/mountainash/taskana"
export AUTHOR="mountainash"
