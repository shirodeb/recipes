...
export PACKAGE="com.github.seobrowse.serp"
export NAME="SEOBrowse"
export VERSION="1.3.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/seobrowse/serp/"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This repository provides SERP query examples."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/seobrowse/serp"
export AUTHOR="seobrowse"
