...
export PACKAGE="com.github.aleksey-hoffman.sigma-file-manager"
export NAME="Sigma File Manager"
export VERSION="1.7.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/aleksey-hoffman/sigma-file-manager/releases/download/v1.7.0/Sigma-File-Manager-1.7.0-Linux-Debian.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Sigma File Manager is a free, open-source, quickly evolving, modern file manager (explorer / finder) app for Windows and Linux."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/aleksey-hoffman/sigma-file-manager"
export AUTHOR="aleksey-hoffman"
