...
export PACKAGE="com.github.safestudio.unofficial-zalo"
export NAME="Unofficial Zalo"
export VERSION="1.0.7"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/SafeStudio/unofficial-zalo"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Unofficial Zalo App"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/SafeStudio/unofficial-zalo"
export AUTHOR="SafeStudio"
