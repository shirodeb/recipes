...
export PACKAGE="com.github.timeseriesadmin.timeseriesadmin"
export NAME="Time Series Admin"
export VERSION="0.1.13"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/timeseriesadmin/timeseriesadmin/releases/download/v0.1.13/TimeSeriesAdmin.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Administration panel and querying interface for InfluxDB databases. (Electron app / Docker container)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/timeseriesadmin/timeseriesadmin"
export AUTHOR="timeseriesadmin"

function build() {
    pushd "$SRC_DIR/${SRC_NAMES[0]}/opt/Time Series Admin"
    cp -r * ${APP_DIR}/files/
