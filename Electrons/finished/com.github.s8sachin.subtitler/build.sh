...
export PACKAGE="com.github.s8sachin.subtitler"
export NAME="Subtitler"
export VERSION="1.5.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/s8sachin/subtitler/releases/download/v1.5.5/Subtitler-1.5.5.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Quickly download subtitles"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/s8sachin/subtitler"
export AUTHOR="s8sachin"
