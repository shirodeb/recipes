...
export PACKAGE="com.github.cjerrington.net-check"
export NAME="Network Status Check"
export VERSION="1.0.8"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/cjerrington/net-check/releases/download/v1.0.8/Network-Status-Check-portable-1.0.8.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A simple application to check the status of a URL and port if it is open or closed"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/cjerrington/net-check"
export AUTHOR="cjerrington"
