...
export PACKAGE="com.github.maxogden.screencat"
export NAME="ScreenCat"
export VERSION="4.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/maxogden/screencat/releases/download/v4.2.0/ScreenCat.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":cat2: webrtc screensharing electron app for mac os (Alpha)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/maxogden/screencat"
export AUTHOR="maxogden"
