...
export PACKAGE="com.github.codecentric.merge-request-notifier"
export NAME="Merge Request Notifier"
export VERSION="1.9.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/codecentric/merge-request-notifier/releases/download/v1.9.0/merge-request-notifier-1.9.0.tar.xz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This app shows your merge requests grouped by projects and WIP status. It is accessible from the system tray."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/codecentric/merge-request-notifier"
export AUTHOR="codecentric"
