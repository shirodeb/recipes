...
export PACKAGE="com.github.supunlakmal.thismypc"
export NAME="ThisMyPC"
export VERSION="0.3.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/supunlakmal/thismypc"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="ThisMyPC provides a neat web interface that can be used for browsing your desktop drives from any device in your browser itself. With the help of NodeJs, the file details are displayed in JSON format that can then we easily displayed in web browsers."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/supunlakmal/thismypc"
export AUTHOR="supunlakmal"
