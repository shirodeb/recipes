...
export PACKAGE="com.github.patentlobster.stinker"
export NAME="Stinker"
export VERSION="0.3.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/PatentLobster/stinker"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Snippets keeper&executer for Laravel tinker"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/PatentLobster/stinker"
export AUTHOR="PatentLobster"
