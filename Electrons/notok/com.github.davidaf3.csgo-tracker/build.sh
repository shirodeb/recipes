...
export PACKAGE="com.github.davidaf3.csgo-tracker"
export NAME="csgo-tracker"
export VERSION="0.2.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/davidaf3/csgo-tracker/releases/download/v0.2.1/csgo-tracker-linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simple Electron app that lets you track your CS:GO matches and stats"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/davidaf3/csgo-tracker"
export AUTHOR="davidaf3"
