...
export PACKAGE="com.github.moosync.moosync"
export NAME="Moosync"
export VERSION="10.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Moosync/Moosync/releases/download/v10.2.0/Moosync-10.2.0-linux-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Music player capable of playing local audio or from Youtube, Spotify and many more"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Moosync/Moosync"
export AUTHOR="Moosync"
