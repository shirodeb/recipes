...
export PACKAGE="com.github.afractal.twittertron-app"
export NAME="TwitterTron"
export VERSION="1.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/afractal/twittertron-app"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":eyes: TwitterTron product page."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/afractal/twittertron-app"
export AUTHOR="afractal"
