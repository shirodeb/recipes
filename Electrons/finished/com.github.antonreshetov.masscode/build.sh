...
export PACKAGE="com.github.antonreshetov.masscode"
export NAME="massCode"
export VERSION="1.3.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/antonreshetov/massCode/releases/download/v1.3.1/massCode-1.3.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This repository is outdated and no longer maintained. A new version of massCode is available! https://github.com/massCodeIO/massCode. A free and open source code snippets manager for developers."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/antonreshetov/massCode"
export AUTHOR="antonreshetov"
