...
export PACKAGE="com.github.zxch3n.pomodorologger"
export NAME="pomodoro-logger"
export VERSION="0.6.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/zxch3n/PomodoroLogger/releases/download/v0.6.3/pomodoro-logger_0.6.3_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Pomodoro Logger :clock930: -- When a time tracker meets Pomodoro and Kanban board"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/zxch3n/PomodoroLogger"
export AUTHOR="zxch3n"

function build() {
    pushd $SRC_DIR/*
    cp -r 'opt/Pomodoro Logger'/* ${APP_DIR}/files/
