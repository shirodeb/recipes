...
export DEPENDS="libc6 (>= 2.28), libgcc1 (>= 1:3.0), libglib2.0-0 (>= 2.31.8), libnl-3-200 (>= 3.2.7), libnl-genl-3-200 (>= 3.2.7), libnl-route-3-200 (>= 3.2.7), libpcap0.8 (>= 1.5.1), libqt5core5a (>= 5.11.3), libqt5gui5 (>= 5.11.3), libqt5multimedia5 (>= 5.11.3), libqt5printsupport5 (>= 5.11.3), libqt5widgets5 (>= 5.11.3), libstdc++6 (>= 5.2), libwiretap8 (>= 2.6.2), libwscodecs2 (>= 2.5.0), libwsutil9 (>= 2.6.5), zlib1g (>= 1:1.1.4), libc-ares2, libmaxminddb0, libsmi2ldbl, libminizip1, libsnappy1v5, libnghttp2-14, libnl-idiag-3-200, libnl-nf-3-200, libnl-xfrm-3-200, libsbc1, libspandsp2, libkrb5-3, libbrotli1, liblz4-1, libzstd1, liblua5.1-0, libopus0, libspeexdsp1, zenity, libssh-4, deepin-elf-verify (>= 1.1.10-1)"
export DEV_DPEENDS="libminizip-dev libpcap-dev qtmultimedia5-dev libmaxminddb-dev libsmi2-dev libbrotli-dev liblz4-dev libsnappy-dev libnghttp2-dev liblua5.1-0-dev libnl-3-dev libsbc-dev libspandsp-dev libopus-dev libspeexdsp-dev asciidoctor"
