...
export PACKAGE="com.github.el3um4s.markdown-c3"
export NAME="Markdown C3"
export VERSION=".1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/el3um4s/markdown-c3/blob/master/README.md"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Markdown Editor and Previewer"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/el3um4s/markdown-c3"
export AUTHOR="el3um4s"
