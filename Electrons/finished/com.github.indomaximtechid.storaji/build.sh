...
export PACKAGE="com.github.indomaximtechid.storaji"
export NAME="Storaji"
export VERSION="1.0.0-beta.9"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/IndomaximTechID/storaji/releases/download/v1.0.0-beta.9/storaji-1.0.0-beta.9-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":ledger: The light/responsive inventory management system available on Windows, macOS and Linux."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/IndomaximTechId/storaji"
export AUTHOR="IndomaximTechId"
