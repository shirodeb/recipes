...
export PACKAGE="com.github.gnu4cn.gitbook-reader-app"
export NAME="Yet-Another-Gitbook-Reader"
export VERSION="0.8.8"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/gnu4cn/gitbook-reader-app/releases/download/v0.8.8/Yet-Another-Gitbook-Reader-0.8.8-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="YAGR, Yet Another Gitbook Reader, a gitbook reader with advanced archtecture, and easy to use. 一个架构先进、简单易用的读书神器。"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/gnu4cn/gitbook-reader-app"
export AUTHOR="gnu4cn"
