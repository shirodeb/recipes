...
export PACKAGE="com.github.rivafarabi.deckboard"
export NAME="Deckboard"
export VERSION="2.1.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/rivafarabi/deckboard/releases/download/v2.1.4/Deckboard-2.1.4.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Control your PC with your phone in easy way possible. News and updates on @DeckboardApp."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/rivafarabi/deckboard"
export AUTHOR="rivafarabi"
