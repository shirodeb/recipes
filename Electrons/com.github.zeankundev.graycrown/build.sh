...
export PACKAGE="com.github.zeankundev.graycrown"
export NAME="Graycrown"
export VERSION="1.2.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/zeankundev/Graycrown/releases/download/v1.2.1/graycrown-1.2.1-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Old Coal. Now revived with a new name!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/zeankundev/graycrown"
export AUTHOR="zeankundev"
