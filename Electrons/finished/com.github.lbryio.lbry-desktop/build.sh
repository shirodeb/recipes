...
export PACKAGE="com.github.lbryio.lbry-desktop"
export NAME="LBRY Desktop"
export VERSION="0.53.9"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/lbryio/lbry-desktop/releases/download/v0.53.9/LBRY_0.53.9.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A browser and wallet for LBRY, the decentralized, user-controlled content marketplace."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/lbryio/lbry-desktop"
export AUTHOR="lbryio"
