...
export PACKAGE="com.github.sturdy-dev.sturdy"
export NAME="Sturdy"
export VERSION="pi/v1.8.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/sturdy-dev/sturdy"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🐥 Sturdy is an open-source, real-time, version control platform for startups (https://getsturdy.com)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/sturdy-dev/sturdy"
export AUTHOR="sturdy-dev"
