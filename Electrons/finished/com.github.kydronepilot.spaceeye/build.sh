...
export PACKAGE="com.github.kydronepilot.spaceeye"
export NAME="SpaceEye"
export VERSION="1.2.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/KYDronePilot/SpaceEye"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Live geostationary weather satellite imagery for your desktop background"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/KYDronePilot/SpaceEye"
export AUTHOR="KYDronePilot"
