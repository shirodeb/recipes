...
export PACKAGE="com.github.cassidoo.todometer"
export NAME="todometer"
export VERSION="2.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/cassidoo/todometer/releases/download/v2.0.1/todometer.for.linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A meter-based to-do list"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/cassidoo/todometer"
export AUTHOR="cassidoo"
