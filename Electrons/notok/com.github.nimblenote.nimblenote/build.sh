...
export PACKAGE="com.github.nimblenote.nimblenote"
export NAME="nimblenote"
export VERSION="3.2.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/nimblenote/nimblenote/releases/download/v3.2.2/nimblenote-3.2.2.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simple keyboard-driven note taking application for macOS, Linux and Windows."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/nimblenote/nimblenote"
export AUTHOR="nimblenote"
