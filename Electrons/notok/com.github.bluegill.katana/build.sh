...
export PACKAGE="com.github.bluegill.katana"
export NAME="Katana"
export VERSION="1.4.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/bluegill/katana"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🚀 a powerful, open-source screenshot utility for macOS"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/bluegill/katana"
export AUTHOR="bluegill"
