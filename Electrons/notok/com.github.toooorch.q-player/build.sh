...
export PACKAGE="com.github.toooorch.q-player"
export NAME="Q-player"
export VERSION="1.0.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Toooorch/q-player/releases/download/1.0.4/WIN_Q-player_Portable_1.0.4.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Public Repo with releases for Q-player"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Toooorch/q-player"
export AUTHOR="Toooorch"
