...
export PACKAGE="com.github.dhanyn10.multiple-file-manager"
export NAME="Multiple File Manager"
export VERSION="4.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/dhanyn10/multiple-file-manager/releases/download/v4.0.0/mfm_4.0.0_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="File management application. You can bulk rename or deleting your files at the same time, with certain condition. Available for windows and linux"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/dhanyn10/multiple-file-manager"
export AUTHOR="dhanyn10"
