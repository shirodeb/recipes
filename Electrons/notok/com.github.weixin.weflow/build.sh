...
export PACKAGE="com.github.weixin.weflow"
export NAME="WeFlow"
export VERSION="1.3.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Tencent/WeFlow/releases/download/1.3.3/WeFlow-1.3.3-win32-ia32.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A web developer workflow tool by WeChat team based on tmt-workflow, with cross-platform supported and environment ready."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/weixin/WeFlow"
export AUTHOR="weixin"
