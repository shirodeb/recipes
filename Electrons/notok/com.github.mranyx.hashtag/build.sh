...
export PACKAGE="com.github.mranyx.hashtag"
export NAME="HashTag"
export VERSION="1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/MrAnyx/HashTag"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Electron app to hash or verify hash"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/MrAnyx/HashTag"
export AUTHOR="MrAnyx"
