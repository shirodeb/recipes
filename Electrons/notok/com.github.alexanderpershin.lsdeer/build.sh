...
export PACKAGE="com.github.alexanderpershin.lsdeer"
export NAME="lsdeer"
export VERSION="0.1.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/AlexanderPershin/lsdeer"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="file manager"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/AlexanderPershin/lsdeer"
export AUTHOR="AlexanderPershin"
