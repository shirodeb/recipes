...
export PACKAGE="com.github.kanekotic.barklarm"
export NAME="Barklarm"
export VERSION="1.11.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Barklarm/barklarm-app/releases/download/v1.11.4/barklarm-linux-x64-1.11.4.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="displays the status of projects as an item in the tray menu bar"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/kanekotic/barklarm"
export AUTHOR="kanekotic"
