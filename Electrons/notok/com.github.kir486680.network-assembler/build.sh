...
export PACKAGE="com.github.kir486680.network-assembler"
export NAME="NetworkAssembler"
export VERSION="0.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/kir486680/Network-Assembler/releases/download/0.0.2/Network-Assembler.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Network Assembler is a simple way to create neural networks in Keras"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/kir486680/Network-Assembler"
export AUTHOR="kir486680"
