...
export PACKAGE="com.github.magiccap.magiccap"
export NAME="MagicCap"
export VERSION="2.1.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/MagicCap/MagicCap/releases/download/v2.1.2/magiccap-linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="MagicCap is an image/GIF capture suite for Mac and Linux."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/MagicCap/MagicCap"
export AUTHOR="MagicCap"
