...
export PACKAGE="com.github.thephucit.tunlookup"
export NAME="Tunlookup"
export VERSION="3.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/thephucit/tunlookup"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Translates selected text with a keystroke"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/thephucit/tunlookup"
export AUTHOR="thephucit"
