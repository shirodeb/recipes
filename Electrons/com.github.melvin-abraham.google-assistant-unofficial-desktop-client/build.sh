...
export PACKAGE="com.github.melvin-abraham.google-assistant-unofficial-desktop-client"
export NAME="Unofficial Desktop Client for Google Assistant"
export VERSION="1.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Melvin-Abraham/Google-Assistant-Unofficial-Desktop-Client/releases/download/v1.1.0/Google-Assistant-Setup-1.1.0-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A cross-platform unofficial Google Assistant Client for Desktop (powered by Google Assistant SDK)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Melvin-Abraham/Google-Assistant-Unofficial-Desktop-Client"
export AUTHOR="Melvin-Abraham"
