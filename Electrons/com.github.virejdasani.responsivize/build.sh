...
export PACKAGE="com.github.virejdasani.responsivize"
export NAME="Responsivize"
export VERSION="3.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/virejdasani/Responsivize/releases/download/v3.0.0/Responsivize-Linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A must-have tool to develop responsive websites 📲"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/virejdasani/Responsivize"
export AUTHOR="virejdasani"
