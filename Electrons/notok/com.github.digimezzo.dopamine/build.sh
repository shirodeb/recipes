...
export PACKAGE="com.github.digimezzo.dopamine"
export NAME="Dopamine"
export VERSION="3.0.0-preview20"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/digimezzo/dopamine/releases/download/v3.0.0-preview20/Dopamine-3.0.0-preview.20.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The audio player that keeps it simple"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/digimezzo/dopamine"
export AUTHOR="digimezzo"
