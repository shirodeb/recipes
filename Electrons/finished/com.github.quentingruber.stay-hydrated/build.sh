...
export PACKAGE="com.github.quentingruber.stay-hydrated"
export NAME="stay-hydrated"
export VERSION="1.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/QuentinGruber/stay-hydrated/releases/download/v1.1.0/stay-hydrated-1.1.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="(Desktop app) Reminder to drink water"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/QuentinGruber/stay-hydrated"
export AUTHOR="QuentinGruber"
