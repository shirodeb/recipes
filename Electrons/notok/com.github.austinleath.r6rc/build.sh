...
export PACKAGE="com.github.austinleath.r6rc"
export NAME="R6RC"
export VERSION="0.4.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/austinleath/r6rc"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This repository contains the source code for the Rainbow Six: Siege MMR Calculator"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/austinleath/r6rc"
export AUTHOR="austinleath"
