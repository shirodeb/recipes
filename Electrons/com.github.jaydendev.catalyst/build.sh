...
export PACKAGE="com.github.jaydendev.catalyst"
export NAME="Catalyst Web Browser"
export VERSION="3.5.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/CatalystDevOrg/Catalyst/releases/download/v3.5.4/catalyst-3.5.4.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Catalyst web browser"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/JaydenDev/Catalyst"
export AUTHOR="JaydenDev"
