...
export PACKAGE="com.github.ciderapp.cider"
export NAME="Cider"
export VERSION="1.6.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ciderapp/Cider/releases/download/v1.6.2/Cider-1.6.2.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A new cross-platform Apple Music experience based on Electron and Vue.js written from scratch with performance in mind. 🚀"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/ciderapp/Cider"
export AUTHOR="ciderapp"
