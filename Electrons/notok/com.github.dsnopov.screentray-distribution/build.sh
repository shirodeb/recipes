...
export PACKAGE="com.github.dsnopov.screentray-distribution"
export NAME="ScreenTray"
export VERSION="1.7.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/DSnopov/screentray-distribution"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="macOS app for capturing, annotating and sharing screenshots"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/DSnopov/screentray-distribution"
export AUTHOR="DSnopov"
