...
export PACKAGE="com.github.virejdasani.geniemoji"
export NAME="Geniemoji"
export VERSION="6.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/virejdasani/Geniemoji/releases/download/v6.0.0/Geniemoji-Linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Geniemoji - The Emoji Genie 🧞‍♂️"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/virejdasani/Geniemoji"
