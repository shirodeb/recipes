...
export PACKAGE="com.github.dscalzi.helioslauncher"
export NAME="Helios Launcher"
export VERSION="2.0.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/dscalzi/HeliosLauncher"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="☀ Custom launcher for modded minecraft written in Electron and Node.js"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/dscalzi/HeliosLauncher"
export AUTHOR="dscalzi"
