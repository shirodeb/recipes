...
export PACKAGE="com.github.felipeleivav.dbcloner-app"
export NAME="DBcloner"
export VERSION="0.1.0-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/felipeleivav/dbcloner-app/releases/download/v0.1.0-beta/dbcloner-0.1.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A database cloning tool for the desktop"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/felipeleivav/dbcloner-app"
export AUTHOR="felipeleivav"
