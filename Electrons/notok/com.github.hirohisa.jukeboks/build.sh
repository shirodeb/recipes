...
export PACKAGE="com.github.hirohisa.jukeboks"
export NAME="Jukeboks"
export VERSION="2.2.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/hirohisa/Jukeboks/releases/download/v2.2.4/Jukeboks.app.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Jukeboks is a fast viewer / player app"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/hirohisa/Jukeboks"
export AUTHOR="hirohisa"
