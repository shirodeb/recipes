...
export PACKAGE="com.github.wurde.themebuilder"
export NAME="themebuilder"
export VERSION="4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/wurde/themebuilder"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A set of components for agile development."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/wurde/themebuilder"
export AUTHOR="wurde"
