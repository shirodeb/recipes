...
export PACKAGE="com.github.alexdevero.instatron"
export NAME="Instatron"
export VERSION="1.5.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/alexdevero/instatron"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A simple Instagram desktop uploader & client app build with electron.Mobile Instagram on desktop!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/alexdevero/instatron"
export AUTHOR="alexdevero"
