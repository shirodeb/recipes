...
export PACKAGE="com.github.nodemailer.nodemailer-app"
export NAME="NodemailerApp"
export VERSION="1.0.16"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/nodemailer/nodemailer-app/releases/download/v1.0.16/NodemailerApp-1.0.16-full.nupkg"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Releases for NodemailerApp, the ultimate email debugging tool"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/nodemailer/nodemailer-app"
export AUTHOR="nodemailer"
