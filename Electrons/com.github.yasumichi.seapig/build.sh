...
export PACKAGE="com.github.yasumichi.seapig"
export NAME="SeaPig"
export VERSION="0.8.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/yasumichi/seapig/releases/download/v0.8.2/seapig-linux-x64-0.8.2.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="SeaPig is converter from markdown to html with marked.js and highlight.js."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/yasumichi/seapig"
export AUTHOR="yasumichi"
