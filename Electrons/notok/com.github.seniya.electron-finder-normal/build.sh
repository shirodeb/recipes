...
export PACKAGE="com.github.seniya.electron-finder-normal"
export NAME="Simple-Finder"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/seniya/electron-finder-normal/releases/download/1.0.0/Simple-Finder.Setup.1.0.0.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Study for basic function of file finder with electron and vue."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/seniya/electron-finder-normal"
export AUTHOR="seniya"
