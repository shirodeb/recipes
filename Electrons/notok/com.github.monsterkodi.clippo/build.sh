...
export PACKAGE="com.github.monsterkodi.clippo"
export NAME="clippo"
export VERSION="1.40.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/monsterkodi/clippo"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="clipboard tool"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/monsterkodi/clippo"
