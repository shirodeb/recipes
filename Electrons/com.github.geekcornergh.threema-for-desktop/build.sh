...
export PACKAGE="com.github.geekcornergh.threema-for-desktop"
export NAME="Threema For Desktop"
export VERSION="2.5.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/GeekCornerGH/threema-for-desktop/releases/download/v2.5.1/Threema-For-Desktop-linux-2.5.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Unofficial desktop client for Threema"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/GeekCornerGH/Threema-For-Desktop"
export AUTHOR="GeekCornerGH"
