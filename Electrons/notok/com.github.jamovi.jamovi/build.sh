...
export PACKAGE="com.github.jamovi.jamovi"
export NAME="jamovi"
export VERSION="1.6.15"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jamovi/jamovi"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="jamovi - open software to bridge the gap between researcher and statistician"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jamovi/jamovi"
export AUTHOR="jamovi"
