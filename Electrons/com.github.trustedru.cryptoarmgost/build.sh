...
export PACKAGE="com.github.trustedru.cryptoarmgost"
export NAME="CryptoARM GOST"
export VERSION="2.5.12"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/CryptoARM/CryptoARMGOST/releases/download/v2.5.12/cryptoarm-gost-v2.5.12-linux-x64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="КриптоАРМ ГОСТ - программа для защиты электронных документов."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/TrustedRu/CryptoARMGOST"
export AUTHOR="TrustedRu"
