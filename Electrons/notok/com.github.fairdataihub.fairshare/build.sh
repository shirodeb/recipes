...
export PACKAGE="com.github.fairdataihub.fairshare"
export NAME="FAIRshare"
export VERSION="2.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/fairdataihub/FAIRshare/releases/download/v2.1.0/FAIRshare-2.1.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simplifying the curation and sharing of biomedical research data and software according to applicable FAIR guidelines"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/fairdataihub/FAIRshare"
export AUTHOR="fairdataihub"
