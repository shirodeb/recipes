...
export PACKAGE="com.github.brimsec.zui"
export NAME="Zui"
export VERSION="1.3.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/brimdata/zui/releases/download/v1.3.1/zui_1.3.1_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Zui is a powerful desktop application for exploring and working with data. The official front-end to the Zed lake."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/brimsec/brim"
export AUTHOR="brimsec"

function build() {
    pushd $SRC_DIR/*
    cp -r opt/Zui/* ${APP_DIR}/files/
