...
export PACKAGE="com.github.fupdec.mediachips"
export NAME="mediaChips"
export VERSION="0.11.3-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/fupdec/mediaChips/releases/download/v0.11.3-beta/MediaChips.v0.11.3.Linux.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Manage your videos, add any metadata to them and play them."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/fupdec/mediaChips"
export AUTHOR="fupdec"
