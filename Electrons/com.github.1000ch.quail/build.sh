...
export PACKAGE="com.github.1000ch.quail"
export NAME="Quail"
export VERSION="2.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/1000ch/quail/releases/download/v2.4.0/Quail-2.4.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Unofficial but officially accepted esa app :bird:"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/1000ch/quail"
export AUTHOR="1000ch"
