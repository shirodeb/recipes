...
export PACKAGE="com.github.paologiua.tilde"
export NAME="Tilde"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/paologiua/tilde/releases/download/v1.0.0/Tilde-1.0.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Podcast client to listen to all you favorite podcasts"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/paologiua/tilde"
export AUTHOR="paologiua"
