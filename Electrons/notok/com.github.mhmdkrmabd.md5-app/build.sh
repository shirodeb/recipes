...
export PACKAGE="com.github.mhmdkrmabd.md5-app"
export NAME="MD5 Application"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/mhmdkrmabd/md5-app"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="MD5 hash creation and verification application"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/mhmdkrmabd/md5-app"
export AUTHOR="mhmdkrmabd"
