...
export PACKAGE="com.github.solarfloss.reach-podcast-player"
export NAME="Reach Podcast Player"
export VERSION="1.1.0-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/SolarFloss/Reach-Podcast-Player"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This is a rss-based podcast player made in electron and angular!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/SolarFloss/Reach-Podcast-Player"
export AUTHOR="SolarFloss"
