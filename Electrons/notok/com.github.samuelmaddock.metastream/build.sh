...
export PACKAGE="com.github.samuelmaddock.metastream"
export NAME="Metastream"
export VERSION="0.10.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/samuelmaddock/metastream"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Watch streaming media with friends."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/samuelmaddock/metastream"
export AUTHOR="samuelmaddock"
