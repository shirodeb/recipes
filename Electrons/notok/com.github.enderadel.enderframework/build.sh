...
export PACKAGE="com.github.enderadel.enderframework"
export NAME="EnderFramework"
export VERSION="0.0.1-alpha"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/EnderAdel/EnderFramework"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="EnderFramework is a framework that can be used to create apps using HTML, JS, and CSS."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/EnderAdel/EnderFramework"
export AUTHOR="EnderAdel"
