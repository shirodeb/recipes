...
export PACKAGE="com.github.amitmerchant1990.pomolectron"
export NAME="Pomolectron"
export VERSION="1.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/amitmerchant1990/pomolectron"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":tomato: A pomodoro app for your menubar/tray."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/amitmerchant1990/pomolectron"
