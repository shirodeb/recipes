...
export PACKAGE="com.github.jisco.lotofthings"
export NAME="LoT - Lot of Things"
export VERSION="1.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Jisco/LotOfThings"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Organize and search things via custom properties."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Jisco/LotOfThings"
export AUTHOR="Jisco"
