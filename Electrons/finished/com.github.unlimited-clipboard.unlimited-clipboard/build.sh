...
export PACKAGE="com.github.unlimited-clipboard.unlimited-clipboard"
export NAME="clipboard-manager-electron"
export VERSION="1.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/unlimited-clipboard/unlimited-clipboard/releases/download/v1.0.1/unlimited-clipboard.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="simple clipboard manager with unlimited history on electron"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/unlimited-clipboard/unlimited-clipboard"
export AUTHOR="unlimited-clipboard"
...
function build() {
    ...
    local EXEC_PATH="/opt/apps/$PACKAGE/files/unlimited-clipboard"
    if [[ -z $EXEC_PATH ]]; then
