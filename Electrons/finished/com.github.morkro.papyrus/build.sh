...
export PACKAGE="com.github.morkro.papyrus"
export NAME="Papyrus"
export VERSION="1.0.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/morkro/papyrus/releases/download/1.0.3/Papyrus-linux-1.0.3.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="📄 Unofficial Dropbox Paper desktop app"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/morkro/papyrus"
export AUTHOR="morkro"
