...
export PACKAGE="com.github.haeri.monolithcode2"
export NAME="monolith code"
export VERSION="2.2.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Haeri/monolith-code/releases/download/v2.2.6/monolith-code-2.2.6.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="minimalistic but powerful code editor"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Haeri/MonolithCode2"
export AUTHOR="Haeri"
