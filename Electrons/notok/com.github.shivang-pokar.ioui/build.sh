...
export PACKAGE="com.github.shivang-pokar.ioui"
export NAME="ioui"
export VERSION="1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/shivang-pokar/ioui"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Best way to Run / build ionic app without terminal command"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/shivang-pokar/ioui"
export AUTHOR="shivang-pokar"
