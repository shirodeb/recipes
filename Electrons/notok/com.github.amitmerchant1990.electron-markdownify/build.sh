...
export PACKAGE="com.github.amitmerchant1990.electron-markdownify"
export NAME="Markdownify"
export VERSION="1.4.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/amitmerchant1990/electron-markdownify"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":closed_book: A minimal Markdown editor desktop app"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/amitmerchant1990/electron-markdownify"
export AUTHOR="amitmerchant1990"
