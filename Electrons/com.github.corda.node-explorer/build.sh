...
export PACKAGE="com.github.corda.node-explorer"
export NAME="Corda Node Explorer"
export VERSION="0.1.2-rev"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/corda/node-explorer/releases/download/v0.1.2-rev/Corda.Node.Explorer-0.1.2.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Corda Node Explorer"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/corda/node-explorer"
export AUTHOR="corda"
