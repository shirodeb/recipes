...
export PACKAGE="com.github.mokkapps.scrum-daily-standup-picker"
export NAME="Standup Picker"
export VERSION="2.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Mokkapps/scrum-daily-standup-picker"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A desktop application which can be used in Scrum teams to initiate the daily Scrum meeting."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Mokkapps/scrum-daily-standup-picker"
export AUTHOR="Mokkapps"
