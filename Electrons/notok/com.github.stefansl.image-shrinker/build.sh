...
export PACKAGE="com.github.stefansl.image-shrinker"
export NAME="ImageShrinker"
export VERSION="1.6.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/stefansl/image-shrinker"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="App for macOS. Minify your images and graphics with just one drop. Autorenamed in the same place where it comes from. Immediately!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/stefansl/image-shrinker"
export AUTHOR="stefansl"
