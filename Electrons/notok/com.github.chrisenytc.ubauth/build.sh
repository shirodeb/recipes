...
export PACKAGE="com.github.chrisenytc.ubauth"
export NAME="UbAuth"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/chrisenytc/ubauth"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A desktop app to help developers create access tokens for Uber applications with OAuth 2.0"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/chrisenytc/ubauth"
export AUTHOR="chrisenytc"
