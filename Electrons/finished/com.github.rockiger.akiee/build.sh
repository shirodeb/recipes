...
export PACKAGE="com.github.rockiger.akiee"
export NAME="Akiee"
export VERSION="0.0.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/rockiger/akiee-release/raw/linux-release/dist/akiee-0.0.4.tar.bz2"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A Markdown-based task manager for hackers and people who build stuff."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/rockiger/akiee"
export AUTHOR="rockiger"

function build() {
    pushd $SRC_DIR/*
    cp -r * ${APP_DIR}/files/
    local EXEC_PATH="/opt/apps/$PACKAGE/files/akiee"
    if [[ -z $EXEC_PATH ]]; then
