...
export PACKAGE="com.github.dangeredwolf.moderndeck"
export NAME="ModernDeck for Twitter"
export VERSION="10.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/dangeredwolf/ModernDeck/releases/download/v10.0.0/ModernDeck-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A beautiful, powerful Twitter client for desktop."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/dangeredwolf/ModernDeck"
export AUTHOR="dangeredwolf"
