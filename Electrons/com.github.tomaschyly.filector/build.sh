...
export PACKAGE="com.github.tomaschyly.filector"
export NAME="FileCtor"
export VERSION="1.4.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/tomaschyly/FileCtor/releases/download/v1.4.2/FileCtor-deb-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="File inspector with interactive javascript console."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/tomaschyly/FileCtor"
export AUTHOR="tomaschyly"

function build() {
    __internal.unar "$SRC_DIR/FileCtor-deb-x64/tch-filector_1.4.2_amd64.deb" "$SRC_DIR"
