...
export PACKAGE="com.github.webcatalog.neutron"
export NAME="Clovery"
export VERSION="22.14.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/webcatalog/neutron/releases/download/v22.14.0/template-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Legacy code of the core that powers WebCatalog, Singlebox, Clovery and Skywhale."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/webcatalog/neutron"
export AUTHOR="webcatalog"
