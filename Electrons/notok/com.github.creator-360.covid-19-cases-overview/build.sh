...
export PACKAGE="com.github.creator-360.covid-19-cases-overview"
export NAME="Covid-19 cases overview"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Creator-360/Covid-19-cases-overview"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Creator-360/Covid-19-cases-overview"
export AUTHOR="Creator-360"
