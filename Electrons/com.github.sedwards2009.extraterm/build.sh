...
export PACKAGE="com.github.sedwards2009.extraterm"
export NAME="Extraterm"
export VERSION="0.74.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/sedwards2009/extraterm/releases/download/v0.74.0/extratermqt-0.74.0-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The swiss army chainsaw of terminal emulators"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/sedwards2009/extraterm"
export AUTHOR="sedwards2009"

export INGREDIENTS=("glibc" "qt5")

function build() {
    local natives=($(find ${SRC_DIR}/ -name "extratermqt"))
    local root_dir=$(dirname ${natives[0]})
    pushd $root_dir
    cp -r * ${APP_DIR}/files/
    local chrome_sandboxes=($(find ${APP_DIR}/files -name "chrome[-_]sandbox"))
    local natives=($(find ${APP_DIR}/files -name "extratermqt"))
    local root_dir=$(dirname ${natives[0]})
