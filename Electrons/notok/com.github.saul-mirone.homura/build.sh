...
export PACKAGE="com.github.saul-mirone.homura"
export NAME="homura"
export VERSION="0.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Saul-Mirone/homura/releases/download/v0.1.0/Homura-linux-x64-0.1.0.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Homura RSS Reader"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Saul-Mirone/homura"
export AUTHOR="Saul-Mirone"
