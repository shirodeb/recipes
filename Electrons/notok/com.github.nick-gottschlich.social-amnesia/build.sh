...
export PACKAGE="com.github.nick-gottschlich.social-amnesia"
export NAME="Social Amnesia"
export VERSION="2.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Nick-Gottschlich/Social-Amnesia/releases/download/v2.0.2/social_amnesia_2.0.2_amd64-LINUX.snap"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Forget the past. Social Amnesia makes sure your social media accounts only show your posts from recent history, not from "that phase" 5 years ago."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Nick-Gottschlich/Social-Amnesia"
export AUTHOR="Nick-Gottschlich"
