...
export PACKAGE="com.github.fakob.movieprint_v004"
export NAME="MoviePrint"
export VERSION="0.2.23"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/fakob/MoviePrint_v004/releases/download/0.2.23/MoviePrint_v004-0.2.23-win.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="MoviePrint | A tool which lets you create screenshots of entire movies in an instant."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/fakob/MoviePrint_v004"
export AUTHOR="fakob"
