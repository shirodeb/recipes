...
export PACKAGE="com.github.itsjustaplant.spofly"
export NAME="spofly"
export VERSION="1.7.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/itsjustaplant/spofly"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop app for spofly"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/itsjustaplant/spofly"
export AUTHOR="itsjustaplant"
