...
export PACKAGE="com.github.ridereceipts.ridereceipts"
export NAME="Ride Receipts"
export VERSION="1.7.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ridereceipts/ridereceipts"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🚕 Simple automation desktop app to download and organize your receipts from Uber/Lyft. Try out our new Ride Receipts PRO !"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/ridereceipts/ridereceipts"
export AUTHOR="ridereceipts"
