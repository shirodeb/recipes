...
export PACKAGE="com.github.cypress-io.cypress"
export NAME="Cypress"
export VERSION="13.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/cypress-io/cypress/releases/download/v13.4.0/SBOM.rpt"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Fast, easy and reliable testing for anything that runs in a browser."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/cypress-io/cypress"
export AUTHOR="cypress-io"
