...
export PACKAGE="com.github.HoubkneghteS.Weltenschaft"
export NAME="Weltenschaft"
export VERSION="0.4.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/HoubkneghteS/Weltenschaft/releases/download/v0.4.2/Weltenschaft.0.4.2.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Open-Source terrain generator 🗺️"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/HoubkneghteS/Weltenschaft"
export AUTHOR="HoubkneghteS"
