...
export PACKAGE="com.github.aiursoftweb.kahla.app"
export NAME="Kahla"
export VERSION="4.5.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/AiursoftWeb/Kahla.App/releases/download/v4.5.0/kahla-4.5.0.tar.gz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Kahla is a cross-platform business messaging app."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/AiursoftWeb/Kahla.App"
export AUTHOR="AiursoftWeb"
