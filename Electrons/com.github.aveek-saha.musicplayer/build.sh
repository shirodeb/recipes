...
export PACKAGE="com.github.aveek-saha.musicplayer"
export NAME="Dusk Player"
export VERSION="7.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Aveek-Saha/DuskPlayer/releases/download/v7.0.0/DuskPlayer-7.0.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A minimal music player built on electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Aveek-Saha/MusicPlayer"
export AUTHOR="Aveek-Saha"
