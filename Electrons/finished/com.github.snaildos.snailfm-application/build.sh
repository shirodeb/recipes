...
export PACKAGE="com.github.snaildos.snailfm-application"
export NAME="SnailFM"
export VERSION="2.1.8"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/snaildos/SnailFM-Application/releases/download/v2.1.8/SnailFM-2.1.8.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A application to browse SnailFM live music."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/snaildos/SnailFM-Application"
export AUTHOR="snaildos"
