...
export PACKAGE="com.github.thatonecalculator.discordrpcmaker"
export NAME="Discord RPC Maker"
export VERSION="2.1.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="discordrpcmaker-linux.AppImage::https://github.com/ThatOneCalculator/DiscordRPCMaker/releases/download/v2.1.1/discordrpcmaker-linux.appimage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The best way to make and manage custom Discord Rich Presences with buttons!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/thatonecalculator/discordrpcmaker"
export AUTHOR="thatonecalculator"
