...
export PACKAGE="com.github.webdeskme.wdos"
export NAME="wdOS"
export VERSION="1.1.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Webdeskme/wdOS/releases/download/v1.1.2/wdos-1.1.2.tar.gz"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The GUI for WebDesk OS"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Webdeskme/wdOS"
export AUTHOR="Webdeskme"
...
function build() {
    ...
    local EXEC_PATH="/opt/apps/$PACKAGE/files/wdos"
    if [[ -z $EXEC_PATH ]]; then
