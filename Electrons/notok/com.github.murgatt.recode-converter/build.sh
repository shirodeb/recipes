...
export PACKAGE="com.github.murgatt.recode-converter"
export NAME="Recode Converter"
export VERSION="1.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/murgatt/recode-converter"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A modern & simple audio converter for video files"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/murgatt/recode-converter"
export AUTHOR="murgatt"
