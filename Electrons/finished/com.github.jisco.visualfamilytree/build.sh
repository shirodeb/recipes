...
export PACKAGE="com.github.jisco.visualfamilytree"
export NAME="Visual Family Tree"
export VERSION="1.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Jisco/VisualFamilyTree/releases/download/v1.4.0/VisualFamilyTree.1.4.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="With this app you can create a family tree with extensive information and pictures about the individual family members."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Jisco/VisualFamilyTree"
export AUTHOR="Jisco"
