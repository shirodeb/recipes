...
export PACKAGE="com.github.bgpworks.boxhero-electron"
export NAME="BoxHero"
export VERSION="2.2.9"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/bgpworks/boxhero-electron/releases/download/2.2.9/BoxHero-2.2.9-full.nupkg"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="박스히어로 Desktop 앱"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/bgpworks/boxhero-electron"
export AUTHOR="bgpworks"
