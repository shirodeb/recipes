...
export PACKAGE="com.github.picturama.picturama"
export NAME="Picturama"
export VERSION="1.3.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/picturama/picturama/releases/download/v1.3.0/Picturama-1.3.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Digital image organizer powered by the web"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/picturama/picturama"
export AUTHOR="picturama"
