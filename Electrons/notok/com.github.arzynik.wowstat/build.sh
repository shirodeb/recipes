...
export PACKAGE="com.github.arzynik.wowstat"
export NAME="WoW Stat"
export VERSION="3.0.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/arzynik/wowstat"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A World of Warcraft realm status monitor"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/arzynik/wowstat"
export AUTHOR="arzynik"
