...
export PACKAGE="com.github.falconsoft.worksheets-data.studio"
export NAME="WORKSHEETS Data Studio"
export VERSION="3.2.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/FalconSoft/worksheets-data.studio"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Online SQL Client, Exploratory Data Analysis, Data Processing and Low Code Apps"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/FalconSoft/worksheets-data.studio"
export AUTHOR="FalconSoft"
