...
export PACKAGE="com.github.egoist.devdocs-app"
export NAME="devdocs-app"
export VERSION="0.7.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/egoist/devdocs-desktop/releases/download/v0.7.2/DevDocs-0.7.2.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🗂 A full-featured desktop app for DevDocs.io."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/egoist/devdocs-app"
export AUTHOR="egoist"
