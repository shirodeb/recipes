...
export PACKAGE="com.github.alessioforte.transee"
export NAME="Transee"
export VERSION="2.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/alessioforte/transee"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simple and useful tool for quick translation"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/alessioforte/transee"
export AUTHOR="alessioforte"
