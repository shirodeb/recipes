...
export PACKAGE="com.github.openbazaar.openbazaar-desktop"
export NAME="OpenBazaar"
export VERSION="2.4.10"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/OpenBazaar/openbazaar-desktop/releases/download/v2.4.10/openbazaar2client_2.4.10_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="OpenBazaar 2.0 Desktop Client (talks to openbazaar-go server daemon)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/OpenBazaar/openbazaar-desktop"
export AUTHOR="OpenBazaar"
