...
export PACKAGE="com.github.sanjit1.wizardmirror"
export NAME="WizardMirror"
export VERSION="1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://www.github.com/Sanjit1/WizardMirror"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Open source Mirror for Raspberry PI"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Sanjit1/WizardMirror"
export AUTHOR="Sanjit1"
