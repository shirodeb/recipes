...
export PACKAGE="com.github.styunan.japankana"
export NAME="Janpankana"
export VERSION="1.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/styunan/japankana/releases/download/v1.0.2/japankana-1.0.2.AppImage"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/styunan/japankana"
export AUTHOR="styunan"
