...
export PACKAGE="com.github.theotterlord.deckmaster"
export NAME="DeckMaster"
export VERSION="1.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/TheOtterlord/deckmaster/releases/download/v1.0.2/linux-installer.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A prototype deck editor for the Yu-Gi-Oh! TCG"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/TheOtterlord/deckmaster"
export AUTHOR="TheOtterlord"
