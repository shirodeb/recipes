...
export PACKAGE="com.github.Hazyzh.cursor-highlight"
export NAME="Cursor Highlight"
export VERSION="1.0.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Hazyzh/cursor-highlight"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This is a utility tool let other guys easily focus on your mouse cursor. Especially effective when you share screen in a meeting session."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Hazyzh/cursor-highlight"
export AUTHOR="Hazyzh"
