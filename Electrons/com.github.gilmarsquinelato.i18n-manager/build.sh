...
export PACKAGE="com.github.gilmarsquinelato.i18n-manager"
export NAME="i18n Manager"
export VERSION="3.0.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/gilmarsquinelato/i18n-manager/releases/download/3.0.3/i18n-Manager-3.0.3.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Translation management app"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/gilmarsquinelato/i18n-manager"
export AUTHOR="gilmarsquinelato"
