...
export PACKAGE="com.github.mrchuckomo.poddycast"
export NAME="Poddycast"
export VERSION="0.11.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/MrChuckomo/poddycast/releases/download/v0.11.0/Poddycast-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Podcast app made with Electron, lots of ❤️ and ☕️"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/MrChuckomo/poddycast"
export AUTHOR="MrChuckomo"
