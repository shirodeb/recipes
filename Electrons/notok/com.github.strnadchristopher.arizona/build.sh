...
export PACKAGE="com.github.strnadchristopher.arizona"
export NAME="Arizona"
export VERSION="1.0.0-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/strnadchristopher/arizona/releases/download/v1.0.0-beta/Arizona-v1.0.0-beta-Windows.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Customizable personal assistant written in electron, so all css can be changed making it endlessly customizable."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/strnadchristopher/arizona"
export AUTHOR="strnadchristopher"
