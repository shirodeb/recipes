...
export PACKAGE="com.github.mafintosh.playback"
export NAME="Playback"
export VERSION="1.6.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/mafintosh/playback/releases/download/v1.6.0/Playback.app.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Video player built using electron and node.js"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/mafintosh/playback"
export AUTHOR="mafintosh"
