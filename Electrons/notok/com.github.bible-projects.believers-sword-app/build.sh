...
export PACKAGE="com.github.bible-projects.believers-sword-app"
export NAME="Believers Sword"
export VERSION="1.3.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Bible-Projects/believers-sword-app"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Believers Sword App is a piece of software that is made for believers of the bible to help them study the bible."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Bible-Projects/believers-sword-app"
export AUTHOR="Bible-Projects"
