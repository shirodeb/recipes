...
export PACKAGE="com.github.hayhaydz.miv"
export NAME="Minimal Image Viewer"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/hayhaydz/MIV/releases/download/v1.0.0/Minimal-Image-Viewer-1.0.0.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Minimal image viewer. Minimizing the unnecessary. Maximising the necessary. Putting only the image in front of you."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/hayhaydz/MIV"
export AUTHOR="hayhaydz"
