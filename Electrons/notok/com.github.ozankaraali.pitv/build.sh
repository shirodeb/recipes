...
export PACKAGE="com.github.ozankaraali.pitv"
export NAME="PiTV"
export VERSION="1.1.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ozankaraali/PiTV/releases/download/1.1.1/pitv_1.1.1_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A cross-platform STB and IPTV player client"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/ozankaraali/PiTV"
export AUTHOR="ozankaraali"
