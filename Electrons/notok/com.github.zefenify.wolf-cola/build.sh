...
export PACKAGE="com.github.Zefenify.Wolf-Cola"
export NAME="Zefenify"
export VERSION="2.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Zefenify/Wolf-Cola"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Binary Distribution and Issue/Feature Tracking for Project `Wolf Cola`"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Zefenify/Wolf-Cola"
export AUTHOR="Zefenify"
