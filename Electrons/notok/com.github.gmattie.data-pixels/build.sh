...
export PACKAGE="com.github.gmattie.data-pixels"
export NAME="Data Pixels Playground"
export VERSION="1.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/gmattie/Data-Pixels/releases/download/1.1.0/Data.Pixels.Playground-win32-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Create pixel art programmatically.  Includes DataPixels.js and Data Pixels Playground desktop application."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/gmattie/Data-Pixels"
export AUTHOR="gmattie"
