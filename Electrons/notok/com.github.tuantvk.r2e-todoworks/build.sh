...
export PACKAGE="com.github.tuantvk.r2e-todoworks"
export NAME="r2e-todoworks"
export VERSION="0.0.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/tuantvk/r2e-todoworks"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Todo list r2e-todoworks built with React, MobX and Electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/tuantvk/r2e-todoworks"
export AUTHOR="tuantvk"
