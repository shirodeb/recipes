...
export PACKAGE="com.github.kaplanpro.kaplan-desktop"
export NAME="Kaplan Desktop"
export VERSION="0.6.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/kaplanPRO/kaplan-desktop"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop Computer-Assisted Translation tool"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/kaplanPRO/kaplan-desktop"
export AUTHOR="kaplanPRO"
