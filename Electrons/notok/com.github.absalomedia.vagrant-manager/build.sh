...
export PACKAGE="com.github.absalomedia.vagrant-manager"
export NAME="Vagrant Manager"
export VERSION="2.3.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/absalomedia/vagrant-manager/releases/download/2.3.2/vagrant-manager-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Vagrant Manager is an electron, status bar menu app that lets you manage all of your vagrant machines from one central location."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/absalomedia/vagrant-manager"
export AUTHOR="absalomedia"
