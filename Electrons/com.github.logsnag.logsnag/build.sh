...
export PACKAGE="com.github.logsnag.logsnag"
export NAME="LogSnag"
export VERSION="1.8.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/LogSnag/LogSnag/releases/download/v1.8.0/LogSnag-1.8.0.AppImage"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/LogSnag/LogSnag"
export AUTHOR="LogSnag"
