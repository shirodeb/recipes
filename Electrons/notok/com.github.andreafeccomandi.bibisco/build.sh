...
export PACKAGE="com.github.andreafeccomandi.bibisco"
export NAME="bibisco"
export VERSION="2.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/andreafeccomandi/bibisco/"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Novel writing software"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/andreafeccomandi/bibisco"
export AUTHOR="andreafeccomandi"
