...
export PACKAGE="com.github.mozilla.tofino"
export NAME="Tofino"
export VERSION="0.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/mozilla/tofino/releases/download/v0.2.0/tofino-linux-x64.tar.bz2"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Project Tofino is a browser interaction experiment."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/mozilla/tofino"
export AUTHOR="mozilla"
