...
export PACKAGE="com.github.jayakumarreddy.local-mock-server"
export NAME="Local Mock Server"
export VERSION="1.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jayakumarreddy/Local-Mock-Server/releases/download/v1.2.0/Local-Mock-Server-1.2.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="This is a Electron app for spinning up a local mock server quickly"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jayakumarreddy/Local-Mock-Server"
export AUTHOR="jayakumarreddy"
