...
export PACKAGE="com.github.design-first.system-designer"
export NAME="System Designer"
export VERSION="5.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/design-first/system-designer"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A low-code development platform for creating systems 🇺🇦#standwithUkraine"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/design-first/system-designer"
export AUTHOR="design-first"
