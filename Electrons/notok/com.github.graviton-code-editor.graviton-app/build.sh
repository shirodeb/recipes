...
export PACKAGE="com.github.graviton-code-editor.graviton-app"
export NAME="Graviton Editor"
export VERSION="2.3.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Graviton-Code-Editor/Graviton-App/releases/download/v2.3.0/Graviton-Editor_Installer_2.3.0_linux_x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🚀 A modern-looking Code Editor"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Graviton-Code-Editor/Graviton-App"
export AUTHOR="Graviton-Code-Editor"
