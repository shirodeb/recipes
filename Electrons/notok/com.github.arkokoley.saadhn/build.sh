...
export PACKAGE="com.github.arkokoley.saadhn"
export NAME="Saadhn"
export VERSION="0.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/arkokoley/saadhn/releases/download/v0.3/Saadhn-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A desktop client for JioSaavn, based on the official JioSaavn web app. Built with Electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/arkokoley/saadhn"
export AUTHOR="arkokoley"
