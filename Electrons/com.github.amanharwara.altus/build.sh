...
export PACKAGE="com.github.amanharwara.altus"
export NAME="Altus"
export VERSION="4.8.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/amanharwara/altus/releases/download/4.8.6/Altus-4.8.6-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop client for WhatsApp Web with themes, notifications and multiple account support"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/amanharwara/altus"
export AUTHOR="amanharwara"
