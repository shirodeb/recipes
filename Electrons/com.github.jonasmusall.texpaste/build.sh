...
export PACKAGE="com.github.jonasmusall.texpaste"
export NAME="texpaste"
export VERSION="1.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jonasmusall/texpaste/releases/download/v1.2.0/texpaste_1.2.0_linux.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Live TeX rendering."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jonasmusall/texpaste"
export AUTHOR="jonasmusall"
