...
export PACKAGE="com.github.afmorenosa.u-stair"
export NAME="U Stair"
export VERSION="0.2.2b"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ccmorenosa/U_Stair/releases/download/v0.2.2-Beta/u_Stair.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="An application for university schedule organization "
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/afmorenosa/U_Stair"
export AUTHOR="afmorenosa"

function build() {
    pushd "$SRC_DIR/${SRC_NAMES[0]}/opt/U Stair"
    cp -r * ${APP_DIR}/files/
