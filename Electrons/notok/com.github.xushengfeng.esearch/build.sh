...
export PACKAGE="com.github.xushengfeng.esearch"
export NAME="eSearch"
export VERSION="1.10.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/xushengfeng/eSearch/releases/download/1.10.0/eSearch-1.10.0-linux-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="截屏 离线OCR 搜索翻译 以图搜图 贴图 录屏 滚动截屏 Screenshot  OCR  search  translate  search for picture  paste the picture on the screen  screen recorder"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/xushengfeng/eSearch"
export AUTHOR="xushengfeng"
