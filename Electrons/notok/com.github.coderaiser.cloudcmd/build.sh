...
export PACKAGE="com.github.coderaiser.cloudcmd"
export NAME="Cloud Commander"
export VERSION="16.17.7"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/coderaiser/cloudcmd"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="✨☁️📁✨ Cloud Commander file manager for the web with console and editor."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/coderaiser/cloudcmd"
export AUTHOR="coderaiser"
