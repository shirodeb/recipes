...
export PACKAGE="com.github.florianfe.papercubes"
export NAME="PaperCubes"
export VERSION="1.3.0-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/FlorianFe/PaperCubes/releases/download/v1.3.0-beta/PaperCubes_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🏡🖨 An App which converts your minecraft .schematic files to blueprints for papercraft"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/FlorianFe/PaperCubes"
export AUTHOR="FlorianFe"

function build() {
    pushd $SRC_DIR/${SRC_NAMES[0]}/opt/PaperCubes/
    cp -r * ${APP_DIR}/files/
