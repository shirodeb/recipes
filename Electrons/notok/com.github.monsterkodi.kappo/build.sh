...
export PACKAGE="com.github.monsterkodi.kappo"
export NAME="kappo"
export VERSION="1.31.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/monsterkodi/kappo"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="application launcher"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/monsterkodi/kappo"
export AUTHOR="monsterkodi"
