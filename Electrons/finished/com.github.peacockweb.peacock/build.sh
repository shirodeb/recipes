...
export PACKAGE="com.github.peacockweb.peacock"
export NAME="Peacock"
export VERSION="2.3.5"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/spikecodes/peacock/releases/download/v2.3.5/peacock_2.3.5_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🦚 Open source experimental private-by-default web browser."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/peacockweb/peacock"
export AUTHOR="peacockweb"
