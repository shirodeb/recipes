...
export PACKAGE="com.github.cozy-labs.cozy-desktop"
export NAME="Cozy Desktop"
export VERSION="3.39.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/cozy-labs/cozy-desktop/releases/download/v3.39.0/Cozy-Drive-3.39.0-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="File Synchronisation for Cozy on Desktop and Laptop"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/cozy-labs/cozy-desktop"
export AUTHOR="cozy-labs"
