...
export PACKAGE="com.github.prsh9.kubectl-dashboard"
export NAME="Kube Dev Dashboard"
export VERSION="0.14.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/prsh9/kubectl-dashboard/releases/download/v0.14.3/kube-dev-dashboard-0.14.3-linux.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Dev Desktop Dashboard for Kubernetes"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/prsh9/KubeCtl-Dashboard"
export AUTHOR="prsh9"
