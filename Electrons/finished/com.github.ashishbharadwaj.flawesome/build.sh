...
export PACKAGE="com.github.ashishbharadwaj.flawesome"
export NAME="Flawesome"
export VERSION="0.2.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/ashishBharadwaj/flawesome/releases/download/v0.2.3/Flawesome-0.2.3.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Productivity Tool"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/ashishBharadwaj/flawesome"
export AUTHOR="ashishBharadwaj"
