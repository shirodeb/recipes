...
export PACKAGE="com.github.decosoftware.deco-ide"
export NAME="Deco IDE"
export VERSION="0.7.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/decosoftware/deco-ide"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="The React Native IDE"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/decosoftware/deco-ide"
export AUTHOR="decosoftware"
