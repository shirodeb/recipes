...
export PACKAGE="info.keeweb"
export NAME="KeeWeb"
export VERSION="1.18.7"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/keeweb/keeweb/releases/download/v$VERSION/KeeWeb-$VERSION.linux.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Free cross-platform password manager compatible with KeePass"
export DESC2=""
export DEPENDS="libfuse2"
export PROVIDES=""
export SECTION="misc"
export HOMEPAGE="https://github.com/keeweb/keeweb"
export AUTHOR=""
