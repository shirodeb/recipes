...
export PACKAGE="com.github.assnctr.unfx-proxy-checker"
export NAME="Unfx Proxy Checker"
export VERSION="1.7.2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/openproxyspace/unfx-proxy-checker/releases/download/v1.7.2/unfx-proxy-checker-v1.7.2-x86_64-linux.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Unfx Proxy Checker - Powerful proxy checker with huge features and beautiful design. Easy sorting and filtering by all parameters."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/assnctr/unfx-proxy-checker"
export AUTHOR="assnctr"
