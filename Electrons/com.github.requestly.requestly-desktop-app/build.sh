...
export PACKAGE="com.github.requestly.requestly-desktop-app"
export NAME="Requestly"
export VERSION="1.5.12"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/requestly/requestly-desktop-app/releases/download/v1.5.12/Requestly-1.5.12.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Requestly Desktop App (Mac, Linux, Windows)"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/requestly/requestly-desktop-app"
export AUTHOR="requestly"
