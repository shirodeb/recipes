...
export PACKAGE="com.github.scratch-for-discord.scratch-for-discord-app"
export NAME="Scratch For Discord"
export VERSION="2.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/androzdev/scratch-for-discord/releases/download/v2.0.1/Scratch-For-Discord-2.0.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop app for Scratch For Discord"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/scratch-for-discord/scratch-for-discord-app"
export AUTHOR="scratch-for-discord"
