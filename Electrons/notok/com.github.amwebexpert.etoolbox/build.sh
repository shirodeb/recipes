...
export PACKAGE="com.github.amwebexpert.etoolbox"
export NAME="Web Toolbox"
export VERSION="v2.1.6"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/amwebexpert/etoolbox"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Collection of web developer utilities packaged as a desktop app. Technologies: React, Typescript, Redux, Axios, React-Query, Electron"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/amwebexpert/etoolbox"
export AUTHOR="amwebexpert"
