...
export PACKAGE="com.github.playcode.playcode-desktop"
export NAME="PlayCode"
export VERSION="2022.12.27"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/playcode/playcode-desktop/releases/download/v2022.12.27/PLAYCODE-2022.12.27.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Desktop client for Playcode Online Javascript Editor"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/playcode/playcode-desktop"
export AUTHOR="playcode"
