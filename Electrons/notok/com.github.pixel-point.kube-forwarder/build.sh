...
export PACKAGE="com.github.pixel-point.kube-forwarder"
export NAME="Kube Forwarder"
export VERSION="1.5.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/pixel-point/kube-forwarder/releases/download/v1.5.1/kube-forwarder.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Easy to use Kubernetes port forwarding manager"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/pixel-point/kube-forwarder"
export AUTHOR="pixel-point"
