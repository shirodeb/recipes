...
export PACKAGE="com.github.symphonyoss.symphonyelectron"
export NAME="Symphony"
export VERSION="23.9.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/symphonyoss/SymphonyElectron"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A desktop client for the Symphony Collaboration Platform built using Electron"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/symphonyoss/SymphonyElectron"
export AUTHOR="symphonyoss"
