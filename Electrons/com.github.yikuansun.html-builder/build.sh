...
export PACKAGE="com.github.yikuansun.html-builder"
export NAME="HTML Builder"
export VERSION="2.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/yikuansun/html-builder/releases/download/v2.0.1/HTML.Builder-2.0.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Effortlessly create desktop apps out of HTML, CSS, and JS."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/yikuansun/html-builder"
export AUTHOR="yikuansun"
