...
export PACKAGE="com.github.kevinjobs.horen"
export NAME="Horen"
export VERSION="0.1.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/kevinjobs/horen/releases/download/v0.1.1/horen-0.1.1-win.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="使用 React & Electron 打造的本地音乐播放器 Music player by electron and reactjs"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/kevinjobs/Horen"
export AUTHOR="kevinjobs"
