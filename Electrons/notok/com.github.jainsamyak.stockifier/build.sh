...
export PACKAGE="com.github.jainsamyak.stockifier"
export NAME="Stockifier"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/jainsamyak/Stockifier/releases/download/v1.0.0/Stockifier-v1.0.0.Windows10.Setupx64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A notification and insights app for stock markets"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/jainsamyak/Stockifier"
export AUTHOR="jainsamyak"
