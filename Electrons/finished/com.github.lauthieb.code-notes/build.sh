...
export PACKAGE="com.github.lauthieb.code-notes"
export NAME="Code Notes"
export VERSION="1.2.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/lauthieb/code-notes/releases/download/1.2.4/code-notes-1.2.4-x86_64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="(No longer maintained) A simple code snippet & gist manager for developers built with Electron & Vue.js 🚀"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/lauthieb/code-notes"
export AUTHOR="lauthieb"
