...
export PACKAGE="com.github.sentialx.multrin"
export NAME="Multrin"
export VERSION="1.3.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/sentialx/multrin/releases/download/v1.3.0/Multrin-1.3.0-ia32-win.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Organize apps windows in tabs like in abandoned Windows Sets and more"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/sentialx/multrin"
export AUTHOR="sentialx"
