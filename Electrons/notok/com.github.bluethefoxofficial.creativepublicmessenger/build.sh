...
export PACKAGE="com.github.bluethefoxofficial.creativepublicmessenger"
export NAME="Enclica Messenger"
export VERSION="rerel"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/bluethefoxofficial/CreativePublicMessenger"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/bluethefoxofficial/CreativePublicMessenger"
export AUTHOR="bluethefoxofficial"
