...
export PACKAGE="com.github.connor-davis.peershare"
export NAME="PeerShare"
export VERSION="0.0.9"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/connor-davis/peershare"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="PeerShare is a peer-to-peer file sharing app."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/connor-davis/peershare"
export AUTHOR="connor-davis"
