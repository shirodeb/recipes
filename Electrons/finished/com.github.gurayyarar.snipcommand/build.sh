...
export PACKAGE="com.github.gurayyarar.snip-command"
export NAME="SnipCommand"
export VERSION="0.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/gurayyarar/SnipCommand/releases/download/v0.1.0/SnipCommand-0.1.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A free and open source command snippets manager for organize and copy fast."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/gurayyarar/SnipCommand"
export AUTHOR="gurayyarar"
...
function build() {
    ...
    local EXEC_PATH="/opt/apps/$PACKAGE/files/snipcommand"
    if [[ -z $EXEC_PATH ]]; then
