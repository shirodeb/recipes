...
export PACKAGE="com.github.kunalnagar.encrypt0r"
export NAME="encrypt0r"
export VERSION="3.11.55"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/kunalnagar/encrypt0r/releases/download/v3.11.55/encrypt0r-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="App to encrypt and decrypt your files with a passphrase, powered by :electron:"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/kunalnagar/encrypt0r"
export AUTHOR="kunalnagar"
