...
export PACKAGE="com.github.z17.home-accounting-system"
export NAME="Cromberg"
export VERSION="1.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/z17/home-accounting-system/releases/download/v1.4.0/cromberg_1.4.0_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Personal finance accounting system"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/z17/home-accounting-system"
export AUTHOR="z17"

function build() {
    pushd $SRC_DIR/*
    cp -r opt/Cromberg/* ${APP_DIR}/files/
