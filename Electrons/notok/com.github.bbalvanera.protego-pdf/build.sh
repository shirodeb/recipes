...
export PACKAGE="com.github.bbalvanera.protego-pdf"
export NAME="ProtegoPDF"
export VERSION="1.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/bbalvanera/protego-pdf/releases/download/1.0.1/protego-pdf-1.0.1.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="ProtegoPDF"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/bbalvanera/protego-pdf"
export AUTHOR="bbalvanera"
