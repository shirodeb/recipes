...
export PACKAGE="com.github.varundevpro.calcy"
export NAME="Calcy"
export VERSION="1.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/varundevpro/calcy/releases/download/v1.1.0/linux-unpacked.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A calculator app developed using electron"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/VarunDevPro/calcy"
export AUTHOR="VarunDevPro"
