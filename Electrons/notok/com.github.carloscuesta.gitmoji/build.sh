...
export PACKAGE="com.github.carloscuesta.gitmoji"
export NAME="gitmoji"
export VERSION="3.14.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/carloscuesta/gitmoji"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="An emoji guide for your commit messages. 😜 "
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/carloscuesta/gitmoji"
export AUTHOR="carloscuesta"
