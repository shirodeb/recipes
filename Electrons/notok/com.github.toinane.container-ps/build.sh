...
export PACKAGE="com.github.toinane.container-ps"
export NAME="Container PS"
export VERSION="1.3.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Toinane/container-ps"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Little app to show all docker images"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Toinane/container-ps"
export AUTHOR="Toinane"
