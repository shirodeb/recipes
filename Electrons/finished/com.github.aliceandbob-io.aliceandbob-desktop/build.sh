...
export PACKAGE="com.github.aliceandbob-io.aliceandbob-desktop"
export NAME="aliceandbob.io"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/aliceandbob-io/aliceandbob-desktop/releases/download/v1.0.0/aliceandbob.io_1.0.0_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🔐 A free, light and easy to use desktop tool to generate PGP key pairs, encrypt and decrypt messages."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/aliceandbob-io/aliceandbob-desktop"
export AUTHOR="aliceandbob-io"

function build() {
    pushd $SRC_DIR/*
    cp -r usr/lib/aliceandbob.io ${APP_DIR}/files/
