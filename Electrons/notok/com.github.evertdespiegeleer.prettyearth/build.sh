...
export PACKAGE="com.github.evertdespiegeleer.prettyearth"
export NAME="PrettyEarth"
export VERSION="1.0.4-beta"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/evertdespiegeleer/PrettyEarth/releases/download/v1.0.4-beta/macOS.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A minimal macOS application allowing the use of Google Earth View images as your wallpaper."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/evertdespiegeleer/PrettyEarth"
export AUTHOR="evertdespiegeleer"
