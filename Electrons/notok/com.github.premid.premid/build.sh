...
export PACKAGE="com.github.premid.premid"
export NAME="PreMiD"
export VERSION="pp-v2.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/PreMiD/PreMiD/releases/download/app-v2.2.0/PreMiD-win32-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="🧬 Source code of the PreMiD application."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/PreMiD/PreMiD"
export AUTHOR="PreMiD"
