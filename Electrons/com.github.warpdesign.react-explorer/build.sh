...
export PACKAGE="com.github.warpdesign.react-explorer"
export NAME="React-Explorer"
export VERSION="3.1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/warpdesign/react-explorer/releases/download/v3.1.0/react-explorer-3.1.0-linux-amd64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="File manager written in TypeScript, React, Blueprint and packaged with Electron"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/warpdesign/react-explorer"
export AUTHOR="warpdesign"
