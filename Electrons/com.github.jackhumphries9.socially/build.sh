...
export PACKAGE="com.github.jackhumphries9.socially"
export NAME="Socially"
export VERSION="1.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/JackHumphries9/Socially/releases/download/V1.0/Socially-Linux_1.0.0-amd64.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Group all of your socials in one window!"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/JackHumphries9/Socially"
export AUTHOR="JackHumphries9"
