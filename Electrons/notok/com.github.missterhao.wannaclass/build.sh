...
export PACKAGE="com.github.missterhao.wannaclass"
export NAME="Wanna Class"
export VERSION="1.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/MissterHao/WannaClass"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/MissterHao/WannaClass"
export AUTHOR="MissterHao"
