...
export PACKAGE="com.github.silexlabs.silex-desktop"
export NAME="Silex website builder"
export VERSION="2.7.30"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/silexlabs/silex-desktop/releases/download/v2.7.30/silex-desktop-2.7.30.AppImage"
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/silexlabs/silex-desktop"
export AUTHOR="silexlabs"
