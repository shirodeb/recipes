...
export PACKAGE="com.github.tenpi.photo-viewer"
export NAME="Photo Viewer"
export VERSION="0.2.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Tenpi/Photo-Viewer/releases/download/v0.2.0/Photo-Viewer-0.2.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="An image/GIF viewer that can apply various resizing and color effects."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Tenpi/Photo-Viewer"
export AUTHOR="Tenpi"
