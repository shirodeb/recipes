...
export PACKAGE="com.github.saisandeepvaddi.ten-hands"
export NAME="Ten Hands"
export VERSION="2.10.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/saisandeepvaddi/ten-hands/releases/download/v2.10.3/ten-hands-app_2.10.3_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="⚡ Simplest way to organize and run command-line tasks"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/saisandeepvaddi/ten-hands"
export AUTHOR="saisandeepvaddi"

function build() {
    pushd "$SRC_DIR/${SRC_NAMES[0]}/opt/Ten Hands"
    cp -r * ${APP_DIR}/files/
