...
export PACKAGE="com.github.spluxx.protoman"
export NAME="Protoman"
export VERSION="0.4.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/spluxx/Protoman/releases/download/v0.4.1/Protoman-0.4.1.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Postman for protobuf APIs"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/spluxx/protoman"
export AUTHOR="spluxx"
