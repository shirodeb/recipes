...
export PACKAGE="com.github.pablopunk.healthi-app"
export NAME="healthi"
export VERSION="4.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/pablopunk/healthi-app/releases/download/4.0.1/Healthi_4.0.1_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Simple app to check your laptop's battery health."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/pablopunk/healthi-app"
export AUTHOR="pablopunk"
