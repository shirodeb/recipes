...
export PACKAGE="com.github.sprout2000.leafview"
export NAME="LeafView"
export VERSION="2.7.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/sprout2000/leafview/releases/download/v2.7.3/LeafView-2.7.3-linux-x64.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A minimalist image viewer based on Leaflet.js and Electron."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/sprout2000/leafview"
export AUTHOR="sprout2000"
