...
export PACKAGE="com.github.perbothner.domterm"
export NAME="DomTerm"
export VERSION="2.9.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/PerBothner/DomTerm/releases/download/2.9.4/DomTerm.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="DOM/JavaScript-based terminal-emulator/console"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/PerBothner/DomTerm"
export AUTHOR="PerBothner"
