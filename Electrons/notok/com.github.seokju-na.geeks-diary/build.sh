...
export PACKAGE="com.github.seokju-na.geeks-diary"
export NAME="Geeks Diary"
export VERSION="1.0.0-beta2"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/seokju-na/geeks-diary"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="TIL writing tool for programmer"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/seokju-na/geeks-diary"
export AUTHOR="seokju-na"
