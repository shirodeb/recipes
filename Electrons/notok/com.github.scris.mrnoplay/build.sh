...
export PACKAGE="com.github.scris.mrnoplay"
export NAME="Mr Noplay"
export VERSION="4.0.1"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/mrnoplay/mrnoplay/releases/download/4.0.1/mrnoplay.4.0.1.win.7z"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Give an end to no-end rests and play times. On Windows, macOS and Web."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/scris/mrnoplay"
export AUTHOR="scris"
