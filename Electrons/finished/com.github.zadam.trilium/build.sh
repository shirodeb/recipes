...
export PACKAGE="com.github.zadam.trilium"
export NAME="Trilium Notes"
export VERSION="0.60.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/zadam/trilium/releases/download/v0.60.4/trilium_0.60.4_amd64.deb"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Build your personal knowledge base with Trilium Notes"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/zadam/trilium"
export AUTHOR="zadam"
