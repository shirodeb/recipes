...
export PACKAGE="com.github.tenpi.music-player"
export NAME="Music Player"
export VERSION="0.2.3"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/Tenpi/Music-Player/releases/download/v0.2.3/Music-Player-0.2.3.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="A music player with real-time pitch shifting, time stretching, and reversing effects."
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/Tenpi/Music-Player"
export AUTHOR="Tenpi"
