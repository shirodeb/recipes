...
export PACKAGE="com.github.hunterphillips.countdown"
export NAME="Final-Countdown"
export VERSION="2.0.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/hunterphillips/countdown/releases/download/2.0.0/FinalCountdown.zip"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Productivity desktop application built with Electron and AngularJS "
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/hunterphillips/countdown"
export AUTHOR="hunterphillips"
