...
export PACKAGE="com.github.4gray.oversetter"
export NAME="Oversetter"
export VERSION="0.4.0"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/4gray/oversetter/releases/download/v0.4.0/oversetter-0.4.0.AppImage"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1=":book: Translate text directly from your menubar"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/4gray/oversetter"
export AUTHOR="4gray"
