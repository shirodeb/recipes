...
export PACKAGE="com.github.xanderfrangos.twinkle-tray"
export NAME="Twinkle Tray"
export VERSION="1.15.4"
export ARCH=$(utils.misc.get_current_arch)
export URL="https://github.com/xanderfrangos/twinkle-tray"
# autostart,notification,trayicon,clipboard,account,bluetooth,camera,audio_record,installed_apps
export REQUIRED_PERMISSIONS=""

export DESC1="Easily manage the brightness of your monitors in Windows from the system tray"
export DESC2=""
...
export SECTION="misc"
export PROVIDE=""
export HOMEPAGE="https://github.com/xanderfrangos/twinkle-tray"
export AUTHOR="xanderfrangos"
